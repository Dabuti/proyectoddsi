...
*** *RF22-Calcular gasto mensual*
    Retorna la cantidad de euros que el usuario ha gastado en compras desde el principio de este mes.
...
*** Lista de operaciones
    ...
    2. Mostrar el gasto en compras desde el principio de mes de un usuario a partir de su
       IDUsuario.
       - Esquema de operación:
         #+begin_LaTeX
         \begin{figure}[!htp]
